...
category1.onclick = ()=>{
    ...
    listbox5.style.display = 'none';
    listbox6.style.display = 'none';
    listbox7.style.display = 'none';
    listbox8.style.display = 'none';
    listbox9.style.display = 'none';
    listbox10.style.display = 'none';

    category1.classList.add('active-category');
    category2.classList.remove('active-category');
    category3.classList.remove('active-category');
    category4.classList.remove('active-category');
    category5.classList.remove('active-category');
    category6.classList.remove('active-category');
    category7.classList.remove('active-category');
...
category3.onclick = ()=>{
    ...
    category1.classList.remove('active-category');
    category2.classList.remove('active-category');
    category3.classList.add('active-category');
    category4.classList.remove('active-category');
    category5.classList.remove('active-category');
    category6.classList.remove('active-category');
    category7.classList.remove('active-category');
...
category4.onclick = ()=>{
    ...
    category2.classList.remove('active-category');
    category3.classList.remove('active-category');
    category4.classList.add('active-category');
    category5.classList.remove('active-category');
    category6.classList.remove('active-category');
    category7.classList.remove('active-category');
    category8.classList.remove('active-category');
...
category5.onclick = ()=>{
    ...
    category3.classList.remove('active-category');
    category4.classList.remove('active-category');
    category5.classList.add('active-category');
    category6.classList.remove('active-category');
    category7.classList.remove('active-category');
    category8.classList.remove('active-category');
    category9.classList.remove('active-category');
...
category6.onclick = ()=>{
    ...
    category4.classList.remove('active-category');
    category5.classList.remove('active-category');
    category6.classList.add('active-category');
    category7.classList.remove('active-category');
    category8.classList.remove('active-category');
    category9.classList.remove('active-category');
    category10.classList.remove('active-category');
...
category7.onclick = ()=>{
    ...
    category5.classList.remove('active-category');
    category6.classList.remove('active-category');
    category7.classList.add('active-category');
    category8.classList.remove('active-category');
    category9.classList.remove('active-category');
    category10.classList.remove('active-category');
